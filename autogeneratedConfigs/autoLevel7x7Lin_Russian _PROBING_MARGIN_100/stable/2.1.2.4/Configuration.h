 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, 10, 0 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 100 //ORIGINAL: #define PROBING_MARGIN 10
 ...
 */
#define LCD_LANGUAGE ru //ORIGINAL: #define LCD_LANGUAGE en
